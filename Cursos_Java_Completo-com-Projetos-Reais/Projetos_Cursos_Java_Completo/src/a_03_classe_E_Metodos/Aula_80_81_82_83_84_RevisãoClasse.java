...
public class Aula_80_81_82_83_84_RevisãoClasse {

//	As classes de programação são receitas de um objeto, 
//	aonde têm características e comportamentos, permitindo assim 
//	armazenar propriedades e métodos dentro dela. Para construir uma
//	classe é preciso utilizar o pilar da abstração. Uma classe 
//	geralmente representa um substantivo, por exemplo: uma pessoa,
...
//	como o tipo inteiro contém o molde para as variáveis declaradas
//	como inteiros. A classe envolve, associa, funções e dados, 
//	controlando o acesso a estes, defini-la implica em especificar 
//	os seus atributos (dados) e seus métodos (funções).
//
//	Um programa que utiliza uma interface controladora de um motor 
//	elétrico provavelmente definiria a classe motor. Os atributos 
...
//	Atributos são as propriedades de um objeto. Métodos são as ações que
//	um objeto pode realizar. Os objetos são características definidas 
//	pelas classes. Neles é permitido instanciar objetos da classe para 
//	inicializar os atributos e invocar os métodos.
//
//	Exemplo de Classe Com Cães
//
//	Atributos são as características de um objeto, essas características 
//	também são conhecidas como variáveis, utilizando o exemplo dos cães,
